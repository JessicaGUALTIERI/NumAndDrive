...
namespace NumAndDrive.ViewModels
{
	public class CreateUserViewModel
	{
        ...
        [RegularExpression(@"^[A-Za-zÀ-ÖØ-öø-ÿ' -]+$", ErrorMessage = "Le nom ne peut contenir que des lettres ou des ' et -")]
        [StringLength(100, MinimumLength = 1, ErrorMessage = "Le nom saisi doit faire entre 1 et 100 caractères")]
        public string LastName { get; set; }

        [Required(ErrorMessage = "Le prénom est obligatoire.")]
        [RegularExpression(@"^[A-Za-zÀ-ÖØ-öø-ÿ' -]+$", ErrorMessage = "Le prénom ne peut contenir que des lettres ou des ' et -")]
